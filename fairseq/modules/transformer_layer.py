...
class TransformerDecoderLayer(nn.Module):
    ...
    *args.decoder_normalize_before* to ``True``.
    ...
    def __init__(self, args, layer_index, no_encoder_attn=False, add_bias_kv=False, add_zero_attn=False):
        super().__init__()
        self.layer_index = layer_index
    ...
    def build_self_attention(self, embed_dim, args, add_bias_kv=False, add_zero_attn=False):
        if args.mask_layer_type == 'dec-dec' and self.layer_index == args.mask_layer:
            return MultiheadAttention(
                embed_dim,
    ...
    def build_encoder_attention(self, embed_dim, args):
        if args.mask_layer_type == 'enc-dec' and self.layer_index == args.mask_layer:
            return MultiheadAttention(
                embed_dim,
                args.decoder_attention_heads,
    ...
    def forward(
        ...
        if self.cross_self_attention and not (
            ...
            y = x
        print("Guy comment - > Decoder layer")

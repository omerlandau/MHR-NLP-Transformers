...
def _main(args, output_file):
    ...
    for sample in progress:
        ...
        print("Guy comment -> test shape: {}".format(models[0].decoder.layers[5].encoder_attn_variables["weights"].shape))
        print("Guy comment -> test : {}".format(models[0].decoder.layers[5].encoder_attn_variables["weights"][0]))
